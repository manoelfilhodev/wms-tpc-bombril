...
return [
    ...
    */
    ...
    'expedicao_rotas' => [
        ...
        'truck_time_multiplier' => (float) env('EXPEDICAO_ROTAS_TRUCK_TIME_MULTIPLIER', 1.6),
        'truck_fixed_buffer_minutes' => (int) env('EXPEDICAO_ROTAS_TRUCK_FIXED_BUFFER_MINUTES', 20),
        'truck_min_minutes' => (int) env('EXPEDICAO_ROTAS_TRUCK_MIN_MINUTES', 60),
        'truck_average_speed_kmh' => (float) env('EXPEDICAO_ROTAS_TRUCK_AVERAGE_SPEED_KMH', 45),
