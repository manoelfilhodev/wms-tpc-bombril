        ...
        <div class="leftside-menu-container">
            <ul class="side-nav">
                ...
                <li class="side-nav-item">
                    <a href="{{ route('demandas.dashboardOperacional') }}" class="side-nav-link {{ request()->routeIs('demandas.dashboardOperacional') ? 'active' : '' }}">
                ...
                <li class="side-nav-item">
                    <a href="{{ route('demandas.operacional') }}" class="side-nav-link {{ request()->routeIs('demandas.operacional') ? 'active' : '' }}">
                ...
                <li class="side-nav-item">
                    <a href="{{ route('demandas.relatorios') }}" class="side-nav-link {{ request()->routeIs('demandas.relatorios') ? 'active' : '' }}">
