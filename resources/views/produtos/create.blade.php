...
<div class="container-fluid px-4 py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h3 class="mb-1 fw-bold text-dark">Novo Produto</h3>
                <p class="text-muted mb-0 small">Cadastre um novo produto no sistema</p>
            </div>
        </div>
    </div>
            ...
            <form action="{{ route('produtos.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="sku" class="form-control border-start-0" value="{{ old('sku') }}" placeholder="Digite o SKU" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="ean" class="form-control border-start-0" value="{{ old('ean') }}" placeholder="Código de barras (EAN)">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="descricao" class="form-control border-start-0" value="{{ old('descricao') }}" placeholder="Descrição do produto" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="quantidade_estoque" class="form-control border-start-0" value="{{ old('quantidade_estoque', 0) }}" placeholder="0" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="lastro" class="form-control border-start-0" value="{{ old('lastro', 0) }}" placeholder="0" required>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="camada" class="form-control border-start-0" value="{{ old('camada', 0) }}" placeholder="0" required>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="paletizacao" class="form-control border-start-0" value="{{ old('paletizacao', 0) }}" placeholder="0" required>
                        </div>
                    </div>
                </div>
