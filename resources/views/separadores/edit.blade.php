...
<div class="container-fluid px-4 py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h3 class="mb-1 fw-bold text-dark">Editar Separador</h3>
                <p class="text-muted mb-0 small">Atualize os dados do separador operacional</p>
            </div>
        </div>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <form action="{{ route('separadores.update', $separador) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nome" class="form-control @error('nome') is-invalid @enderror"
                                   value="{{ old('nome', $separador->nome) }}" required>
                            @error('nome')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="chapa" class="form-control @error('chapa') is-invalid @enderror"
                                   value="{{ old('chapa', $separador->chapa) }}" required>
                            @error('chapa')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="cargo" class="form-control @error('cargo') is-invalid @enderror"
                                   value="{{ old('cargo', $separador->cargo) }}">
                            @error('cargo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="turno" class="form-control @error('turno') is-invalid @enderror"
                                   value="{{ old('turno', $separador->turno) }}">
                            @error('turno')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
